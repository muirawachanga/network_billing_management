...
class SMSCommunication(Document):
    @frappe.whitelist()
    def create_receiver_list(self):
        ...
        # Captive portal customers
        elif self.send_to == "Captive Customer":
            rec = frappe.db.sql(
                """SELECT DISTINCT mtl.first_name, mtl.mobile_number 
            FROM `tabMpesa Transaction Log` mtl where mtl.creation between '%s' and '%s';"""
